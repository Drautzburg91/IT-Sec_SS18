...
\begin{figure}[h]
	...
	\label{fig:appStat}
\end{figure}
>>>>>>> 66682d7215989c0d73dbf7020f54987020360b15
...
Diese Begriffe werden folgend für den Rahmen dieses Berichts definiert.
...
Der Begriff demilitarisierte Zone kommt ursprünglich aus dem militärischen Umfeld und beschreibt eine Zone oder Bereich in der sich keine militärischen Streitkräfte gegenüberstehen dürfen, quasi eine neutrale Zone. In der Netzwerktechnik wird dieser Begriff benutzt, um eine Zone zu beschreiben welche sich zwischen zwei Schutzeinrichtungen befindet. Bei diesen Schutzeinrichtungen handelt es sind meistens um die externe Firewall und die interne Firewall. Der Hintergrund dieses Vorgehens, ist der der Sicherheit, es soll verhindern, dass jede Komponente  innerhalb der DMZ keinen Schaden auf das Intranet ausübt im Falle eines Angriffs.
